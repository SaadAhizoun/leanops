...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[1.5rem] border border-white/70 bg-card/95 text-card-foreground shadow-[0_14px_38px_rgba(15,23,42,0.06)] ring-1 ring-slate-950/5 backdrop-blur transition-[transform,box-shadow,border-color,background-color] duration-300 ease-out hover:-translate-y-[1px] hover:shadow-[0_18px_42px_rgba(15,23,42,0.08)] focus-within:-translate-y-[1px] focus-within:border-slate-300",
      className,
    )}
    {...props}
  />
